...
const start = require(
  unicodeVersion + "/Binary_Property/ID_Start/code-points.js"
).filter((ch) => ch > 0x7f);
let last = -1;
const cont = [0x200c, 0x200d].concat(
  require(
    unicodeVersion + "/Binary_Property/ID_Continue/code-points.js"
...
const astralIdentifierStartCodes =
  "export default " + JSON.stringify(startData.astral).split(",").join(", ");
const astralIdentifierCodes =
  "export default " + JSON.stringify(contData.astral).split(",").join(", ");
const nonASCIIidentifierStartChars =
  'export default "' + startData.nonASCII + '"';
