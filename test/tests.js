...
testFail("({x = 0}.x = 0)", "Shorthand property assignments are valid only in destructuring patterns (1:4)", {ecmaVersion: 6})
testFail("({__proto__: a, __proto__: b}.x = 0)", "Redefinition of __proto__ property (1:16)", {ecmaVersion: 6})
testFail("({a = 0}.x += 0)", "Shorthand property assignments are valid only in destructuring patterns (1:4)", {ecmaVersion: 6})
testFail("({__proto__: a, __proto__: b}.x += 0)", "Redefinition of __proto__ property (1:16)", {ecmaVersion: 6})
testFail("[{a = 0}, {b = 0}.x] = []", "Shorthand property assignments are valid only in destructuring patterns (1:4)", {ecmaVersion: 6})
testFail("[{x = 0}].x = 0", "Shorthand property assignments are valid only in destructuring patterns (1:4)", {ecmaVersion: 6})
testFail("[{x = 0}.y = 1] = []", "Shorthand property assignments are valid only in destructuring patterns (1:4)", {ecmaVersion: 6})
...
testFail("({...{b = 0}.x} = {})", "Shorthand property assignments are valid only in destructuring patterns (1:8)", {ecmaVersion: 9})
...
testFail("for ({__proto__: a, __proto__: b}.x of []) ;", "Redefinition of __proto__ property (1:20)", {ecmaVersion: 6})
testFail("for ({a = 0}.x in {}) ;", "Shorthand property assignments are valid only in destructuring patterns (1:8)", {ecmaVersion: 6})
