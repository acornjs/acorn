...
testFail("async function* foo() { }", "Unexpected token (1:14)", {
  ecmaVersion: 8,
});
...
testFail(
  "async function wrap() {\nasync function await() { }\n}",
  "Cannot use 'await' as identifier inside an async function (2:15)",
  { ecmaVersion: 8 }
);
testFail(
  "async function foo(await) { }",
  "Cannot use 'await' as identifier inside an async function (1:19)",
  { ecmaVersion: 8 }
);
testFail(
  "async function foo() { return {await} }",
  "Cannot use 'await' as identifier inside an async function (1:31)",
  { ecmaVersion: 8 }
);
...
testFail("(async\nfunction foo() { })", "Unexpected token (2:0)", {
  ecmaVersion: 8,
});

// cannot combine with generators.
testFail("(async function* foo() { })", "Unexpected token (1:15)", {
  ecmaVersion: 8,
});
...
testFail(
  "(async function await() { })",
  "Cannot use 'await' as identifier inside an async function (1:16)",
  { ecmaVersion: 8 }
);
testFail(
  "(async function foo(await) { })",
...
testFail(
  "(async function foo() { return {await} })",
  "Cannot use 'await' as identifier inside an async function (1:32)",
  { ecmaVersion: 8 }
);
...
testFail(
  "async ({a = b})",
  "Shorthand property assignments are valid only in destructuring patterns (1:10)",
  { ecmaVersion: 8 }
);
...
testFail(
  "async await => 1",
  "Cannot use 'await' as identifier inside an async function (1:6)",
  { ecmaVersion: 8 }
);
testFail(
  "async (await) => 1",
  "Cannot use 'await' as identifier inside an async function (1:7)",
  { ecmaVersion: 8 }
);
testFail(
  "async (...await) => 1",
  "Cannot use 'await' as identifier inside an async function (1:10)",
  { ecmaVersion: 8 }
);
testFail(
  "async ({await}) => 1",
  "Cannot use 'await' as identifier inside an async function (1:8)",
  { ecmaVersion: 8 }
);
testFail(
  "async ({a: await}) => 1",
  "Cannot use 'await' as identifier inside an async function (1:11)",
  { ecmaVersion: 8 }
);
...
testFail(
  "async (b = {await}) => 1",
  "Cannot use 'await' as identifier inside an async function (1:12)",
  { ecmaVersion: 8 }
);
testFail(
  "async (b = {a: await}) => 1",
  "Cannot use 'await' as identifier inside an async function (1:15)",
  { ecmaVersion: 8 }
);
test("async (b = {await: a}) => 1", {}, { ecmaVersion: 8 });
testFail(
...
testFail(
  ...
  "Cannot use 'await' as identifier inside an async function (1:17)",
  { ecmaVersion: 8 }
);
...
testFail("({async get foo() { }})", "Unexpected token (1:12)", {
  ecmaVersion: 8,
});
testFail("({async set foo(value) { }})", "Unexpected token (1:12)", {
  ecmaVersion: 8,
});
...
testFail(
  ...
  "Cannot use 'await' as identifier inside an async function (1:24)",
  { ecmaVersion: 8 }
);
...
testFail(
  ...
  "Constructor can't be an async method (1:15)",
  { ecmaVersion: 8 }
);
testFail("class A {async get foo() { }}", "Unexpected token (1:19)", {
  ecmaVersion: 8,
});
testFail("class A {async set foo(value) { }}", "Unexpected token (1:19)", {
  ecmaVersion: 8,
});
testFail("class A {async* foo() { }}", "Unexpected token (1:14)", {
  ecmaVersion: 8,
});
testFail("class A {static async get foo() { }}", "Unexpected token (1:26)", {
  ecmaVersion: 8,
});
testFail(
...
testFail("class A {static async* foo() { }}", "Unexpected token (1:21)", {
  ecmaVersion: 8,
});
...
testFail(
  ...
  "Cannot use 'await' as identifier inside an async function (1:27)",
  { ecmaVersion: 8 }
);
testFail(
...
testFail("async function foo() { await }", "Unexpected token (1:29)", {
  ecmaVersion: 8,
});
testFail("(async function foo() { await })", "Unexpected token (1:30)", {
  ecmaVersion: 8,
});
testFail("async () => await", "Unexpected token (1:17)", { ecmaVersion: 8 });
testFail("({async foo() { await }})", "Unexpected token (1:22)", {
  ecmaVersion: 8,
});
testFail("(class {async foo() { await }})", "Unexpected token (1:28)", {
  ecmaVersion: 8,
});
...
testFail(
  ...
  "Await expression cannot be a default value (1:23)",
  { ecmaVersion: 8 }
);
testFail(
  "(async function foo(a = await b) {})",
  "Await expression cannot be a default value (1:24)",
  { ecmaVersion: 8 }
);
testFail("async (a = await b) => {}", "Unexpected token (1:17)", {
  ecmaVersion: 8,
});
testFail(
  "async function wrapper() {\nasync (a = await b) => {}\n}",
  "Await expression cannot be a default value (2:11)",
  { ecmaVersion: 8 }
);
testFail(
  "({async foo(a = await b) {}})",
  "Await expression cannot be a default value (1:16)",
  { ecmaVersion: 8 }
);
testFail(
  "(class {async foo(a = await b) {}})",
  "Await expression cannot be a default value (1:22)",
  { ecmaVersion: 8 }
);
testFail(
  "async function foo(a = class extends (await b) {}) {}",
  "Await expression cannot be a default value (1:38)",
  { ecmaVersion: 8 }
);
...
testFail(
  "async function wrap() {\n(a = await b) => a\n}",
  "Await expression cannot be a default value (2:5)",
  { ecmaVersion: 8 }
);
...
testFail(
  "async function wrap() {\n({a = await b} = obj) => a\n}",
  "Await expression cannot be a default value (2:6)",
  { ecmaVersion: 8 }
);
...
testFail(
  "function* wrap() {\nasync(a = yield b) => a\n}",
  "Yield expression cannot be a default value (2:10)",
  { ecmaVersion: 8 }
);
...
testFail("if (x) async function f() {}", "Unexpected token (1:7)", {
  ecmaVersion: 8,
});

testFail("(async)(a) => 12", "Unexpected token (1:11)", { ecmaVersion: 8 });

testFail("f = async ((x)) => x", "Parenthesized pattern (1:11)", {
  ecmaVersion: 8,
});
...
testFail("abc: async function a() {}", "Unexpected token (1:5)", {
  ecmaVersion: 8,
});

testFail("(async() => { await 4 ** 2 })()", "Unexpected token (1:22)", {
  ecmaVersion: 8,
});

test("(async() => { await (4 ** 2) })()", {}, { ecmaVersion: 8 });

testFail("async() => (await 1 ** 3)", "Unexpected token (1:20)", {
  ecmaVersion: 8,
});

test("async() => (await (1 ** 3))", {}, { ecmaVersion: 8 });

testFail("async() => await 5 ** 6", "Unexpected token (1:19)", {
  ecmaVersion: 8,
});

test("async() => await (5 ** 6)", {}, { ecmaVersion: 8 });

testFail("async() => await (5) ** 6", "Unexpected token (1:21)", {
  ecmaVersion: 8,
});

testFail("4 + async() => 2", "Unexpected token (1:12)", {
  ecmaVersion: 8,
  loose: false,
});

testFail("async function𝐬 f() {}", "Unexpected token (1:17)", {
  ecmaVersion: 8,
});

testFail("async () => class { x = await 1 }", "Unexpected token (1:30)", {
  ecmaVersion: 2024,
});

test(
  "async () => class { x = async () => await 1 }",
  {},
  { ecmaVersion: 2024 }
);
...
testFail(
  "async () => class { x = await }",
  "Cannot use keyword 'await' outside an async function (1:24)",
  { ecmaVersion: 2024, sourceType: "module" }
);

testFail("async function\\u1111() { }", "Unexpected token (1:20)", {
  ecmaVersion: 8,
});
