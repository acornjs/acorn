...
testFail(
  "new obj?.()",
  "Optional chaining cannot appear in the callee of new expressions (1:7)",
  { ecmaVersion: 11 }
);
testFail(
  "new obj?.foo()",
...
testFail(
  "obj?.foo\n`template`",
  "Optional chaining cannot appear in the tag of tagged template expressions (2:0)",
  { ecmaVersion: 11 }
);
testFail(
  "obj?.foo = 0",
  "Optional chaining cannot appear in left-hand side (1:0)",
  { ecmaVersion: 11 }
);
testFail(
  "obj?.foo.bar = 0",
...
testFail(
  "for (obj?.foo in {});",
  "Optional chaining cannot appear in left-hand side (1:5)",
  { ecmaVersion: 11 }
);
testFail(
  "for (obj?.foo.bar in {});",
