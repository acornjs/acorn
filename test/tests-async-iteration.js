...
testFail("function f() { for await (x of xs); }", "Unexpected token (1:19)", {
  ecmaVersion: 9,
});
testFail("f = function() { for await (x of xs); }", "Unexpected token (1:21)", {
  ecmaVersion: 9,
});
testFail("f = () => { for await (x of xs); }", "Unexpected token (1:16)", {
  ecmaVersion: 9,
});
testFail(
  "async function f() { () => { for await (x of xs); } }",
...
testFail("async function f() { for await (;;); }", "Unexpected token (1:25)", {
  ecmaVersion: 9,
});
testFail("async function f() { for await (x;;); }", "Unexpected token (1:25)", {
  ecmaVersion: 9,
});
testFail(
  "async function f() { for await (let x = 0;;); }",
  "Unexpected token (1:25)",
  { ecmaVersion: 9 }
);
testFail(
...
testFail("async function* f() { () => await a; }", "Unexpected token (1:34)", {
  ecmaVersion: 9,
});
testFail("async function* f() { () => yield a; }", "Unexpected token (1:34)", {
  ecmaVersion: 9,
});
...
testFail("obj = { async\n* f() {} }", "Unexpected token (2:0)", {
  ecmaVersion: 9,
});
testFail("obj = { *async f() {}", "Unexpected token (1:15)", {
  ecmaVersion: 9,
});
testFail("obj = { *async* f() {}", "Unexpected token (1:14)", {
  ecmaVersion: 9,
});
testFail("obj = { async* f() { () => await a; } }", "Unexpected token (1:33)", {
  ecmaVersion: 9,
});
testFail("obj = { async* f() { () => yield a; } }", "Unexpected token (1:33)", {
  ecmaVersion: 9,
});
testFail("class A { async\n* f() {} }", "Unexpected token (2:0)", {
  ecmaVersion: 9,
});
testFail("class A { *async f() {} }", "Unexpected token (1:17)", {
  ecmaVersion: 9,
});
testFail("class A { *async* f() {} }", "Unexpected token (1:16)", {
  ecmaVersion: 9,
});
testFail(
...
testFail(
  ...
  "The keyword 'yield' is reserved (1:29)",
  { ecmaVersion: 9 }
);
...
testFail("({ \\u0061sync *method(){} })", "Unexpected token (1:14)", {
  ecmaVersion: 9,
});
testFail("void \\u0061sync function* f(){};", "Unexpected token (1:16)", {
  ecmaVersion: 9,
});
testFail("for ( ; false; ) async function* g() {}", "Unexpected token (1:17)", {
  ecmaVersion: 9,
});
...
testFail("for (async of [1]) {}", "Unexpected token (1:14)", {
  ecmaVersion: 9,
});

testFail("async () => { for (async\nof []); }", "Unexpected token (2:0)", {
  ecmaVersion: 9,
});
