...
test(
  "async function test() { await using x = resource; }",
  {
    type: "Program",
    start: 0,
    end: 51,
...
// Using in function
test(
  "function test() { using x = resource; }",
  {
    type: "Program",
    start: 0,
    end: 39,
...
test(
  "async function test() { await using stack = new AsyncDisposableStack(); }",
  {
    type: "Program",
    start: 0,
    end: 73,
...
test(
  "class C { static { using x = resource; } }",
  {
    type: "Program",
    start: 0,
    end: 42,
...
testFail("{ using let = resource; }", "The keyword 'let' is reserved (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
testFail("let using x = resource;", "Unexpected token (1:10)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
testFail(
  "using x = resource;",
  "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement (1:0)",
  { ecmaVersion: 17, sourceType: "script", commonjs: false }
);

// BoundNames contains "let"
testFail(
  "async function test() { await using let = resource; }",
  "The keyword 'let' is reserved (1:36)",
  { ecmaVersion: 17, sourceType: "module" }
);
// BoundNames contains duplicate entries
testFail(
  "async function test() { await using x = resource1, x = resource2; }",
  "Identifier 'x' has already been declared (1:51)",
  { ecmaVersion: 17, sourceType: "module" }
);
...
testFail("{ using x; }", "Missing initializer in using declaration (1:9)", {
  ecmaVersion: 17,
  sourceType: "module",
});
testFail(
  "{ using x = 5, y; }",
  "Missing initializer in using declaration (1:16)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Await using missing initializer
testFail(
  "async function test() { await using x; }",
  "Missing initializer in await using declaration (1:37)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Using with object destructuring is not supported
testFail("{ using {x} = obj; }", "Unexpected token (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});

// Complex object destructuring with renaming is not supported
testFail("{ using {x: y, z} = obj; }", "Unexpected token (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});

// Export using declarations - should fail as they are not allowed
testFail("export using x = resource;", "Unexpected token (1:7)", {
  ecmaVersion: 17,
  sourceType: "module",
});
testFail("export await using x = resource;", "Unexpected token (1:7)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
testFail(
  "{ using x = resource1, x = resource2; }",
  "Identifier 'x' has already been declared (1:23)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Reserved words and strict mode restrictions
testFail("{ using super = resource; }", "Unexpected keyword 'super' (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});
testFail("{ using this = resource; }", "Unexpected keyword 'this' (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});
testFail(
  "'use strict'; { using arguments = resource; }",
  "Binding arguments in strict mode (1:22)",
  { ecmaVersion: 17, sourceType: "module" }
);
testFail(
  "'use strict'; { using eval = resource; }",
  "Binding eval in strict mode (1:22)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Context-sensitive keyword restrictions
testFail(
  "function* gen() { using yield = resource; }",
  "Cannot use 'yield' as identifier inside a generator (1:24)",
  { ecmaVersion: 17, sourceType: "module" }
);
testFail(
  "async function test() { using await = resource; }",
  "Cannot use 'await' as identifier inside an async function (1:30)",
  { ecmaVersion: 17, sourceType: "module" }
);
...
testFail(
  ...
  "Binding arguments in strict mode (1:50)",
  { ecmaVersion: 17, sourceType: "module" }
);
testFail(
  "'use strict'; async function test() { await using eval = resource; }",
  "Binding eval in strict mode (1:50)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Valid destructuring with default values in using - should be an error
testFail("{ using {x = 5} = obj; }", "Unexpected token (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});

// Using with object destructuring and computed property names - should be an error
testFail("{ using {[key]: value} = obj; }", "Unexpected token (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
testFail(
  "async function test() { await using x = resource1, let = resource2; }",
  "The keyword 'let' is reserved (1:51)",
  { ecmaVersion: 17, sourceType: "module" }
);

// Using declaration inside expression (should not be allowed)
testFail("(using x = resource)", "Unexpected token (1:7)", {
  ecmaVersion: 17,
  sourceType: "module",
});

// Using with invalid identifier characters
testFail("{ using \\u0030x = resource; }", "Invalid Unicode escape (1:8)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
testFail(
  "{await using a = x}",
  "Await using cannot appear outside of async function (1:1)",
  { ecmaVersion: 17, sourceType: "script" }
);
testFail(
  "for (await using a of x) {}",
  "Await using cannot appear outside of async function (1:11)",
  { ecmaVersion: 17, sourceType: "script" }
);
...
testFail(
  "switch (x) { case 1: using y = resource; }",
  "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement (1:21)",
  { ecmaVersion: 17, sourceType: "module" }
);
testFail(
  "switch (x) { case 1: break; default: using y = resource; }",
  "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement (1:37)",
  { ecmaVersion: 17, sourceType: "module" }
);
...
testFail("await.using;", "Unexpected token (1:5)", {
  ecmaVersion: 17,
  sourceType: "module",
});
...
test(
  "async function test() { await /* comment */ using x = resource; }",
  {
    type: "Program",
    start: 0,
    end: 65,
...
test(
  "{ using x = condition ? resource1 : resource2; }",
  {
    type: "Program",
    start: 0,
    end: 48,
...
test(
  "async function test() { await usingX; }",
  {
    type: "Program",
    start: 0,
    end: 39,
