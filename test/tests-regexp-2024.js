...
test("/[\\&]/v", {}, { ecmaVersion: 2024 })
testFail("/[\\z]/v", "Invalid regular expression: /[\\z]/: Invalid escape (1:1)", { ecmaVersion: 2024 })
testFail("/[a\\z]/v", "Invalid regular expression: /[a\\z]/: Invalid escape (1:1)", { ecmaVersion: 2024 })
// Union
...
testFail("/[a&&]/v", "Invalid regular expression: /[a&&]/: Invalid character in character class (1:1)", { ecmaVersion: 2024 })
testFail("/[a--b&&c]/v", "Invalid regular expression: /[a--b&&c]/: Invalid character in character class (1:1)", { ecmaVersion: 2024 })
testFail("/[a&&b--c]/v", "Invalid regular expression: /[a&&b--c]/: Invalid character in character class (1:1)", { ecmaVersion: 2024 })
testFail("/[a&&&]/v", "Invalid regular expression: /[a&&&]/: Invalid character in character class (1:1)", { ecmaVersion: 2024 })
test("/[a&&\\&]/v", {}, { ecmaVersion: 2024 })
testFail("/[&&]/v", "Invalid regular expression: /[&&]/: Invalid set operation in character class (1:1)", { ecmaVersion: 2024 })
testFail("/[!!]/v", "Invalid regular expression: /[!!]/: Invalid set operation in character class (1:1)", { ecmaVersion: 2024 })
testFail("/[##]/v", "Invalid regular expression: /[##]/: Invalid set operation in character class (1:1)", { ecmaVersion: 2024 })
