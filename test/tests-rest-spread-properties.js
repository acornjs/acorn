...
testFail(
  "let {...obj1,} = foo",
  "Comma is not permitted after the rest element (1:12)",
  { ecmaVersion: 9 }
);
testFail(
  "let {...obj1,a} = foo",
...
testFail(
  "({...obj1,} = foo)",
  "Comma is not permitted after the rest element (1:9)",
  { ecmaVersion: 9 }
);
testFail(
  "({...obj1,a} = foo)",
...
testFail("({...(obj)}) => {}", "Parenthesized pattern (1:5)", {
  ecmaVersion: 9,
});
testFail("({...(a,b)}) => {}", "Parenthesized pattern (1:5)", {
  ecmaVersion: 9,
});
...
testFail(
  "({get x() {}}) => {}",
  "Object pattern can't contain getter or setter (1:6)",
  { ecmaVersion: 9 }
);
testFail(
  "let {...x, ...y} = {}",
...
testFail(
  "({...x,}) => z",
  "Comma is not permitted after the rest element (1:6)",
  { ecmaVersion: 9 }
);
testFail(
