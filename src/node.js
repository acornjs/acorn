...
pp.startNodeAt = function(pos, loc) {
  ...
  if (Array.isArray(pos)){
    ...
    {
      throw new Error("acorn.Parser: parameter 'pos' to member startNodeAt(pos, loc) is expected to be a number, array given.")
    }
  }
  node.start = pos
  if (this.options.locations)
...
pp.finishNodeAt = function(node, type, pos, loc) {
  ...
  if (Array.isArray(pos)){
    ...
    {
      throw new Error("acorn.Parser: parameter 'pos' to member finishNodeAt(pos, loc) is expected to be a number, array given.")
    }
  }
  node.end = pos
  if (this.options.locations)
