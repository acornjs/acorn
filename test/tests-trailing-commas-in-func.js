...
testFail("class A {static foo(a,) {}}", "Unexpected token (1:22)", {
  ecmaVersion: 7,
});
testFail("(class {foo(a,) {}})", "Unexpected token (1:14)", { ecmaVersion: 7 });
testFail("(class {static foo(a,) {}})", "Unexpected token (1:21)", {
  ecmaVersion: 7,
});
testFail("export default function foo(a,) { }", "Unexpected token (1:30)", {
  ecmaVersion: 7,
  sourceType: "module",
});
testFail("export default (function foo(a,) { })", "Unexpected token (1:31)", {
  ecmaVersion: 7,
  sourceType: "module",
});
testFail("export function foo(a,) { }", "Unexpected token (1:22)", {
  ecmaVersion: 7,
  sourceType: "module",
});
...
testFail(
  "(function(...a,) { })",
  "Comma is not permitted after the rest element (1:14)",
  { ecmaVersion: 8 }
);
testFail(
  "(...a,) => a",
...
testFail(
  "async (...a,) => a",
  "Comma is not permitted after the rest element (1:11)",
  { ecmaVersion: 8 }
);
testFail(
  "({foo(...a,) {}})",
  "Comma is not permitted after the rest element (1:10)",
  { ecmaVersion: 8 }
);
testFail(
  "class A {foo(...a,) {}}",
...
testFail(
  "class A {static foo(...a,) {}}",
  "Comma is not permitted after the rest element (1:24)",
  { ecmaVersion: 8 }
);
testFail(
  "(class {foo(...a,) {}})",
...
testFail(
  "(class {static foo(...a,) {}})",
  "Comma is not permitted after the rest element (1:23)",
  { ecmaVersion: 8 }
);
testFail(
  "export default function foo(...a,) { }",
  "Comma is not permitted after the rest element (1:32)",
  { ecmaVersion: 8, sourceType: "module" }
);
testFail(
  "export default (function foo(...a,) { })",
  "Comma is not permitted after the rest element (1:33)",
  { ecmaVersion: 8, sourceType: "module" }
);
testFail(
  "export function foo(...a,) { }",
...
testFail("class A {static foo(,) {}}", "Unexpected token (1:20)", {
  ecmaVersion: 8,
});
testFail("(class {foo(,) {}})", "Unexpected token (1:12)", { ecmaVersion: 8 });
testFail("(class {static foo(,) {}})", "Unexpected token (1:19)", {
  ecmaVersion: 8,
});
testFail("export default function foo(,) { }", "Unexpected token (1:28)", {
  ecmaVersion: 8,
  sourceType: "module",
});
testFail("export default (function foo(,) { })", "Unexpected token (1:29)", {
  ecmaVersion: 8,
  sourceType: "module",
});
testFail("export function foo(,) { }", "Unexpected token (1:20)", {
  ecmaVersion: 8,
  sourceType: "module",
});
