...
pp.parseExprOp = function(left, leftStartPos, leftStartLoc, minPrec, noIn) {
  ...
  if (Array.isArray(leftStartPos)){
    ...
    {
      throw new Error("acorn.Parser: parameter 'leftStartPos' to member parseExprOp(left, leftStartPos, leftStartLoc, minPrec, noIn) is expected to be a number, array given.")
    }
  }
...
pp.parseSubscripts = function(base, startPos, startLoc, noCalls) {
  if (Array.isArray(startPos)){
    ...
    {
      throw new Error("acorn.Parser: parameter 'startPos' to member parseSubscripts(base, startPos, startLoc, noCalls) is expected to be a number, array given.")
    }
  }
  for (;;) {
    if (this.eat(tt.dot)) {
